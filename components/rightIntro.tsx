function RightIntro() {
	return (
		<div className="w-ful h-full bg-secondary border-l-[1px] border-solid border-l-secondaryBorder border-b-[5px] border-b-primary flex items-center justify-center flex-col">
